...
IOSC_OS_VERSION=-mios-version-min=12.0
IOSC_ARCH=${ARCH}
...
# Build
export LDFLAGS="-arch ${ARCH} -Wl,-dead_strip -miphoneos-version-min=12.0 -L${BUILD_SDKROOT}/usr/lib"
export CFLAGS="-arch ${ARCH} -pipe -no-cpp-precomp -isysroot ${BUILD_SDKROOT} -miphoneos-version-min=12.0 -g3"
